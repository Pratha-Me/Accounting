...
<html lang="en">
    <head>
        ...
        <%
			...
			String tok = request.getRequestedSessionId();
            ...
            try {
                ...
                if (token.length() < 10) {
                    ...
                    out.print("<script>window.location.assign('" + tok + "');</script>");
                }

            } catch (Exception e) {
                out.print("THIS IS EXCEPTION MESSAGE \n <script>window.location.assign('" + path + "');</script>");
            }
        %>
        <title>Welcome  </title>
